...
template<> MANUALVRPLUGIN_API UScriptStruct* StaticStruct<FSop>()
{
	...
	struct Z_CompiledInDeferFile_FID_Hao_NADMA_06_Plugins_ManualVRPlugin_Source_ManualVRPlugin_Public_ManualVRPluginBPLibrary_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Hao_NADMA_06_Plugins_ManualVRPlugin_Source_ManualVRPlugin_Public_ManualVRPluginBPLibrary_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Hao_NADMA_06_Plugins_ManualVRPlugin_Source_ManualVRPlugin_Public_ManualVRPluginBPLibrary_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Hao_NADMA_06_Plugins_ManualVRPlugin_Source_ManualVRPlugin_Public_ManualVRPluginBPLibrary_h_3456464317(TEXT("/Script/ManualVRPlugin"),
		Z_CompiledInDeferFile_FID_Hao_NADMA_06_Plugins_ManualVRPlugin_Source_ManualVRPlugin_Public_ManualVRPluginBPLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Hao_NADMA_06_Plugins_ManualVRPlugin_Source_ManualVRPlugin_Public_ManualVRPluginBPLibrary_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Hao_NADMA_06_Plugins_ManualVRPlugin_Source_ManualVRPlugin_Public_ManualVRPluginBPLibrary_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Hao_NADMA_06_Plugins_ManualVRPlugin_Source_ManualVRPlugin_Public_ManualVRPluginBPLibrary_h_Statics::ScriptStructInfo),
		nullptr, 0);
